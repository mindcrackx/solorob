...
drop database solorob_db; source /home/marcel/Documents/Berufsschule/AWP/htdocs/AWP/projektwoche/create_solorob_db.sql; source /home/marcel/Documents/Berufsschule/AWP/htdocs/AWP/projektwoche/create_solorob_db_data.sql;
*/
...
(11) NOT NULL,
    ...
    FOREIGN KEY
(rz_rolle_id)
    REFERENCES tbl_rechte_rolle
(rr_id),

    CONSTRAINT fk_zuordnung_funktion_id
    FOREIGN KEY
(rz_funktion_id)
    REFERENCES tbl_rechte_funktion
(rf_id)
);
...
(
    ...
    komponenten_k_id INT
(11) NOT NULL,
    komponentenattribute_kat_id INT
(11),
    khkat_wert VARCHAR
(45),
...
(komponentenattribute_kat_id)
    REFERENCES tbl_komponentenattribute
(kat_id)
);
...
(11),
    ...
    k_gewaehrleistungsdauer INT
(11),
    k_notiz VARCHAR
(1024),
    k_hersteller VARCHAR
(45),
    komponentenarten_ka_id INT
(11),

    CONSTRAINT fk_komponenten__raeume_id
    FOREIGN KEY
(raeume_r_id)
    REFERENCES tbl_raeume
(r_id),

    CONSTRAINT fk_komponenten__lieferant_id
    FOREIGN KEY
(lieferant_l_id)
    REFERENCES tbl_lieferant
(l_id),

    CONSTRAINT fk_komponenten__komponentenarten_id
    FOREIGN KEY
(komponentenarten_ka_id)
    REFERENCES tbl_komponentenarten
(ka_id)
);
