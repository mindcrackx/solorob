...
<body>
    ...
    if(isset($_POST['auswahl']))
    {
        ...
        {
            echo "Es wurde keine Komponente ausgewählt!";
        }
        else
        {
            header("Location: Neubeschaffung.php?id=" . $_POST["id_selected"]);
        }
    }
    echo("<h1>Komponente zum Duplizieren auswählen:</h1>");
    ...
    <br/>
    <br/>
    <input type="submit" name="auswahl" value="Duplizieren">
    </form>
</body>